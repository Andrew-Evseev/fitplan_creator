...
enum ActivityLevel {
  sedentary('Сидячий образ жизни', 1.2, 'Работа за компьютером, мало движения в течение дня'),
  light('Легкая активность', 1.375, 'Хожу пешком 1-2 км в день, делаю утреннюю зарядку'),
  moderate('Умеренная активность', 1.55, 'Хожу пешком 5+ км в день, регулярно делаю зарядку или лёгкие тренировки'),
  active('Высокая активность', 1.725, 'Работаю весь день на ногах, нахаживаю 15-20 тысяч шагов ежедневно'),
  veryActive('Очень высокая активность', 1.9, 'Моя работа связана с постоянными физическими нагрузками и интенсивной активностью');
